...
public class SeleccionDAO {
    ...
    public boolean registrarSeleccion(Seleccion seleccion) {
        ...
        String sql = "INSERT INTO c_blanco3.seleccion (equipo, continente, director, nacionalidad) values("
                + "'" + seleccion.getNombre() + "', "
    ...
    public List<Seleccion> getSelecciones() {
        ...
        String sql = "SELECT distinct equipo, continente, director, nacionalidad FROM c_blanco3.seleccion ORDER BY equipo ASC";
    ...
    public List<Seleccion> getSelecciones(String dato) {
        ...
        String sql = "SELECT distinct equipo, continente, director, nacionalidad FROM c_blanco3.seleccion where "
                + "equipo iLIKE '%" + dato + "%' "
    ...
    public List<Seleccion> getContinenteDiferente() {
        String sql = "SELECT distinct continente FROM c_blanco3.seleccion ORDER BY continente ASC";
        List<Seleccion> selecciones = new ArrayList<Seleccion>();
        try {
            ResultSet result = BasedeDatos.ejecutarSQL(sql);
    ...
    public List<Seleccion> getNacionalidadDiferente() {
        String sql = "SELECT distinct nacionalidad FROM c_blanco3.seleccion ORDER BY nacionalidad ASC";
        List<Seleccion> selecciones = new ArrayList<Seleccion>();
        try {
            ResultSet result = BasedeDatos.ejecutarSQL(sql);
