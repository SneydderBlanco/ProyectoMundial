...
public class AuditoriaDAO {
    ...
    public List<Auditoria> getAuditoria() {
        ...
        String sql = "SELECT distinct * FROM c_blanco3.auditoria ORDER BY pagina ASC";
    ...
    public void actualizarContador(String pagina){
        String sql = "update c_blanco3.auditoria set contador = contador + 1 where pagina = '"+pagina+"';";
        try {
            ResultSet result = BasedeDatos.ejecutarSQL(sql);
        } catch (Exception e) {
            System.out.println(e.toString());
