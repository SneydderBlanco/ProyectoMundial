...
public class ResultadoDAO {
    ...
    public boolean registrarResultado(Resultado resultado) {
        ...
        String sql = "INSERT INTO c_blanco3.partido (id, grupo, local, visitante, continente_local, continente_visitante, goles_local, goles_visitante) values("
                + "'" + resultado.getId() + "', "
                + "'" + resultado.getGrupo() + "', "
                + "'" + resultado.getLocal() + "', "
    ...
    public List<Resultado> getResultado() {
        ...
        String sql = "SELECT distinct * FROM c_blanco3.partido ORDER BY id ASC";
    ...
    public List<Resultado> getResultado(String dato) {
        ...
        String sql = "SELECT distinct * FROM c_blanco3.partido where "
                + "grupo iLIKE '%" + dato + "%' "
                + "OR local iLIKE '%" + dato + "%' "
